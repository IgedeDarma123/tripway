...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - TripWay</title>
    ...
    <div class="admin-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('admin.tours.index')); ?>" class="<?php echo e(request()->routeIs('admin.tours.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.destinations.index')); ?>" class="<?php echo e(request()->routeIs('admin.destinations.*') ? 'active' : ''); ?>">
...
<?php /**PATH D:\tripway\tripway\resources\views/layouts/admin.blade.php ENDPATH**/ ?>