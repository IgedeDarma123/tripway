                ...
                <tr>
                    <td style="background:white; padding:32px 40px;">
                        ...
                        <p style="font-size:15px; color:#1e293b; margin:0 0 24px;">
                            Halo <strong><?php echo e($booking->contact_name); ?></strong>, 👋<br>
                            ...
                            <tr>
                                <td style="padding:16px 20px;">
                                    ...
                                    <div style="font-size:12px; color:#64748b;">
                                        🕐 <?php echo e($booking->tour->duration); ?> <?php echo e($booking->tour->duration_type == 'hours' ? 'jam' : 'hari'); ?>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                            ...
                            <tr>
                                ...
                                <td style="padding:10px 0; font-size:13px; font-weight:700; color:#1e293b; border-bottom:1px solid #f1f5f9; text-align:right;"><?php echo e($booking->package->name ?? '-'); ?></td>
                            </tr>
                            <tr>
                                <td style="padding:10px 0; font-size:13px; color:#64748b; border-bottom:1px solid #f1f5f9;">Tipe Perjalanan</td>
                                <td style="padding:10px 0; font-size:13px; font-weight:700; color:#1e293b; border-bottom:1px solid #f1f5f9; text-align:right;"><?php echo e(ucfirst($booking->travel_type)); ?></td>
                            </tr>
                            <tr>
                                <td style="padding:10px 0; font-size:13px; color:#64748b; border-bottom:1px solid #f1f5f9;">Tanggal</td>
                                <td style="padding:10px 0; font-size:13px; font-weight:700; color:#1e293b; border-bottom:1px solid #f1f5f9; text-align:right;"><?php echo e($booking->travel_date->format('d M Y')); ?></td>
                            </tr>
                            <tr>
                                <td style="padding:10px 0; font-size:13px; color:#64748b; border-bottom:1px solid #f1f5f9;">Jumlah Peserta</td>
                                <td style="padding:10px 0; font-size:13px; font-weight:700; color:#1e293b; border-bottom:1px solid #f1f5f9; text-align:right;"><?php echo e($booking->num_persons); ?> orang</td>
                            </tr>
                            <tr>
                                <td style="padding:10px 0; font-size:13px; color:#64748b;">Nama Pemesan</td>
                                <td style="padding:10px 0; font-size:13px; font-weight:700; color:#1e293b; text-align:right;"><?php echo e($booking->contact_name); ?></td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                            <tr>
                                <td align="center">
                                    <a href="<?php echo e(route('payment.order-detail', $booking)); ?>"
                ...
                <tr>
                    <td style="background:#f8fafc; border-radius:0 0 16px 16px; padding:24px 40px; text-align:center; border-top:1px solid #e2e8f0;">
                        ...
                        <div style="font-size:11px; color:#94a3b8; line-height:1.6;">
                            ...
                            © <?php echo e(date('Y')); ?> TripWay. All rights reserved.
                        </div>
                    </td>
                </tr>
...
<?php /**PATH D:\tripway\tripway\resources\views/emails/booking-confirmation.blade.php ENDPATH**/ ?>