<?php $__env->startSection('title', 'Upload Bukti Pembayaran - TripWay'); ?>
    ...
    <div class="ucard">
        ...
        <div class="ucard-body">
            ...
            <div class="order-info">
                <div class="title"><?php echo e($booking->tour->title); ?></div>
                <div class="detail">
                    <i class="far fa-calendar" style="margin-right:4px;"></i><?php echo e($booking->travel_date->format('d M Y')); ?>

                    &nbsp;·&nbsp;
                    <i class="fas fa-users" style="margin-right:4px;"></i><?php echo e($booking->num_persons); ?> orang
                    <?php if($booking->payment_type): ?>
                    &nbsp;·&nbsp;
                    <i class="fas fa-credit-card" style="margin-right:4px;"></i><?php echo e(strtoupper($booking->payment_type)); ?>
            ...
            <div class="status-box confirmed">
                ...
                <div>
                    ...
                    <div style="font-size:12px; margin-top:2px;">
                        Dikonfirmasi pada <?php echo e($booking->payment_confirmed_at ? $booking->payment_confirmed_at->format('d M Y H:i') : '-'); ?>
            ...
            <?php if($booking->payment_status !== 'settlement' && $booking->payment_status !== 'pending_verification'): ?>
            ...
            <form action="<?php echo e(route('payment.upload', $booking)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <p style="color:#dc2626; font-size:12px; margin:-12px 0 12px;"><?php echo e($message); ?></p>
                <?php unset($message);
...
<?php echo $__env->make('layouts.tripway', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\tripway\tripway\resources\views/payments/upload.blade.php ENDPATH**/ ?>